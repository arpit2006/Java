...
2. private //Cannot be accesed globally
3. public //Can be accesed globally
4. protected //Cannot be accesed globally

### NON ACCESS MODIFIERS

1. static //Default for java
2. final
3. transient
4. abstract
5. synchronized
...
//In short overloading means polymorphism
...
```java
    public class Circle implements Shape{
      //The methods present in superclasss interface must be implemented in another class also where it is implementing
...
```java
    public class Square implements Shape {
      //Methods are used compulsary from superclass
      @Override
      public void draw() {
...
```java
//Object creation (superclass can be object of subclass but vice versa is not possible)
    Shape sh = new Circle();
    sh.draw();
